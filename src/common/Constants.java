...
public final class Constants {
    ...
    public static final float ROGUE_MODIFICATOR_F = 0.2f;
    public static final float KNIGHT_MODIFICATOR_F = 0.2f;
    public static final float PYROMANCER_MODIFICATOR_F = 0.1f;
    public static final float WIZARD_MODIFICATOR_F = 0.05f;
    // Ignite
    ...
    public static final float ROGUE_MODIFICATOR_I = 0.2f;
    public static final float KNIGHT_MODIFICATOR_I = 0.2f;
    public static final float PYROMANCER_MODIFICATOR_I = 0.1f;
    public static final float WIZARD_MODIFICATOR_I = 0.05f;
    // Knight
    ...
    public static final float ROGUE_MODIFICATOR_E = 0.15f;
    ...
    public static final float ROGUE_MODIFICATOR_S = 0.2f;
    public static final float KNIGHT_MODIFICATOR_S = 0.2f;
    public static final float PYROMANCER_MODIFICATOR_S = 0.1f;
    public static final float WIZARD_MODIFICATOR_S = 0.05f;
    // Wizard
    ...
    public static final float ROGUE_MODIFICATOR_DR = 0.2f;
    public static final float KNIGHT_MODIFICATOR_DR = 0.2f;
    public static final float PYROMANCER_MODIFICATOR_DR = 0.1f;
    public static final float WIRZARD_MODIFICATOR_DR = 0.05f;
    // Deflect
    ...
    public static final float ROQUE_MODIFICATOR_DE = 0.2f;
    public static final float KNIGHT_MODIFICATOR_DE = 0.4f;
    public static final float PYROMANCER_MODIFICATOR_DE = 0.3f;
    // Rogue
    ...
    public static final float ROGUE_MODIFICATOR_B = 0.2f;
    public static final float KNIGHT_MODIFICATOR_B = 0.1f;
    public static final float PYROMANCER_MODIFICATOR_B = 0.25f;
    public static final float WIZARD_MODIFICATOR_B = 0.25f;
    // Paralysis
    ...
    public static final float PYROMANCER_MODIFICATOR_P = 0.2f;
